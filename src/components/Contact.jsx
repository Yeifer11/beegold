...
//  - Izquierda: info de contacto + horarios
//  - Derecha: CTA grande para abrir WhatsApp
// ============================================================================

import { buildWhatsAppLink } from '../data/products.js'

// Info de contacto centralizada (fácil de editar en el futuro)
const contactInfo = [
      ...
      <div className="contacto-inner">
        ...
        <div className="contacto-right">
          ...
          <a
            ...
            className="wa-big"
          >
            {/* Ícono SVG de WhatsApp inline (no necesita librería externa) */}
